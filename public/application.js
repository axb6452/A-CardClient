...
var config = {
  apiOrigins: {
    ...
    production: 'https://infinite-spire-29940.herokuapp.com/'
  }
};
...
var getAllFuelRates = function getAllFuelRates() {
  return $.ajax({
...
var getAllExpenses = function getAllExpenses() {
  return $.ajax({
...
module.exports = {
  getAllFuelRates: getAllFuelRates,
...
var getAllFuelRatesSuccess = function getAllFuelRatesSuccess(data) {
...
var getAllFuelRatesFailure = function getAllFuelRatesFailure() {
  clearFormFields();
  $('.fuelrates-page').show();
  $('.transactions-page').hide();
...
var getAllExpensesSuccess = function getAllExpensesSuccess(data) {
  if (data.expenses.length === 0) {
    ...
    for (var i = 0; i < data.expenses.length; i++) {
      var plate = data.expenses[i].plate.replace(/</g, '&lt;').replace(/>/g, '&gt;');
...
var getAllExpensesFailure = function getAllExpensesFailure() {
  clearFormFields();
  $('.fuelrates-page').hide();
  $('.transactions-page').show();
...
var createExpenseSuccess = function createExpenseSuccess(data) {
  clearFormFields();
  $('#lbl-transactions').text('New Expense Created by user ' + store.user.email).css({ 'color': 'green', 'background-color': 'white', 'opacity': '100' });
  $('#lbl-transactions').show();
  $('#lbl-transactions').fadeTo(5000, 0);
  api.getAllExpenses().then(getAllExpensesSuccess).catch(getAllExpensesFailure);
};

var createExpenseFailure = function createExpenseFailure() {
  clearFormFields();
...
var updateExpenseSuccess = function updateExpenseSuccess(data) {
  clearFormFields();
  $('#lbl-transactions').text('Expense with id ' + data.expense.id + ' has been updated by user ' + store.user.email).css({ 'color': 'green', 'background-color': 'white', 'opacity': '100' });
  $('#lbl-transactions').show();
  $('#lbl-transactions').fadeTo(5000, 0);
  api.getAllExpenses().then(getAllExpensesSuccess).catch(getAllExpensesFailure);
};
...
var deleteExpenseSuccess = function deleteExpenseSuccess() {
  ...
  $('#lbl-transactions').text('Expense with id ' + id + ' has been deleted by user ' + store.user.email).css({ 'color': 'green', 'background-color': 'white', 'opacity': '100' });
  $('#lbl-transactions').show();
  $('#lbl-transactions').fadeTo(5000, 0);
  api.getAllExpenses().then(getAllExpensesSuccess).catch(getAllExpensesFailure);
};
...
module.exports = {
  getAllFuelRatesSuccess: getAllFuelRatesSuccess,
  getAllFuelRatesFailure: getAllFuelRatesFailure,
  getAllExpensesSuccess: getAllExpensesSuccess,
  getAllExpensesFailure: getAllExpensesFailure,
  ...
  deleteExpenseFailure: deleteExpenseFailure,
...
var cardEvents = __webpack_require__(15);
...
var addHandlers = function addHandlers() {
  ...
  $('#login-link').on('click', function () {
    $('#about-page').hide();$('#box-page').show();$('#login-link').addClass('active');$('#about-link').removeClass('active');
  });
  $('#about-link').on('click', function () {
    $('#box-page').hide();$('#about-page').show();$('#login-link').removeClass('active');$('#about-link').addClass('active');
  });
  $('#btn-changepassword').on('click', function () {
    $('#transactions-link').removeClass('active');$('#fuelrates-link').removeClass('active');$('#btn-changepassword').addClass('active');
  });
...
var store = __webpack_require__(1);
var cardApi = __webpack_require__(3);
var cardUi = __webpack_require__(5);

var signUpSuccess = function signUpSuccess(data) {
  clearAuthFields();
  $('#lbl-signup').text('User ' + data.user.email + ' successfully created.').css({ 'color': 'green', 'background-color': 'white', 'opacity': '100' });
...
var signUpFailure = function signUpFailure() {
  clearAuthFields();
  $('#lbl-signup').text('Error during sign up').css({ 'color': 'red', 'background-color': 'white', 'opacity': '100' }).show();
};
...
var signInSuccess = function signInSuccess(data) {
  ...
  $('#lbl-transactions').text('User ' + store.user.email + ' successfully signed in.').css({ 'color': 'green', 'background-color': 'white', 'opacity': '100' });
  $('#lbl-transactions').fadeTo(3000, 0);
  $('#lbl-transactions').show();
  cardApi.getAllExpenses().then(cardUi.getAllExpensesSuccess).catch(cardUi.getAllExpensesFailure);
};

var signInFailure = function signInFailure() {
  clearAuthFields();
  $('#lbl-signin').text('Error during sign in').css({ 'color': 'red', 'background-color': 'white', 'opacity': '100' }).show();
};

var changePasswordSuccess = function changePasswordSuccess() {
  clearAuthFields();
  $('#lbl-transactions').text('Successfully changed password').css({ 'color': 'green', 'background-color': 'white', 'opacity': '100' }).show();
  $('#lbl-transactions').fadeTo(3000, 0);
};

var changePasswordFailure = function changePasswordFailure() {
  clearAuthFields();
  $('#lbl-transactions').text('Error during change password').css({ 'color': 'red', 'background-color': 'white', 'opacity': '100' }).show();
};
...
var signOutSuccess = function signOutSuccess() {
  ...
  $('#about-page').hide();
  $('#box-page').show();
  $('#lbl-signin').text('User ' + store.user.email + ' successfully signed out.').css({ 'color': 'green', 'background-color': 'white', 'opacity': '100' });
  $('#lbl-signin').show();
...
var signOutFailure = function signOutFailure() {
  clearAuthFields();
  $('#lbl-transactions').text('Error during sign out').css({ 'color': 'red', 'background-color': 'white', 'opacity': '100' }).show();
  $('#lbl-transactions').show();
};
...
var onGetFuelRates = function onGetFuelRates(event) {
  $('#transactions-link').removeClass('active');
  $('#btn-changepassword').removeClass('active');
  $('#fuelrates-link').addClass('active');
  api.getAllFuelRates().then(ui.getAllFuelRatesSuccess).catch(ui.getAllFuelRatesFailure);
};

var onGetTransactions = function onGetTransactions(event) {
  $('#transactions-link').addClass('active');
  $('#fuelrates-link').removeClass('active');
  $('#btn-changepassword').removeClass('active');
  api.getAllExpenses().then(ui.getAllExpensesSuccess).catch(ui.getAllExpensesFailure);
};
...
var onAdd = function onAdd(event) {
  ...
  var checkPlateInjection = /<|>/g.test($('#txtaddplate').val());
  var totalGallonNaN = isNaN($('#txtaddtotalgallons').val());
  if ($('#txtaddplate').val() === '' || checkPlateInjection === true) {
    ...
    api.createExpense(data).then(ui.createExpenseSuccess).catch(ui.createExpenseFailure);
  }
};
...
var onUpdate = function onUpdate(event) {
  ...
  var checkPlateInjection = /<|>/g.test($('#txtupdateplate').val());
  var totalGallonNaN = isNaN($('#txtupdatetotalgallons').val());
  if ($('#txtupdateid').val() === '') {
    $('#txtupdateid').css({
      'border': 'solid',
      'border-color': 'red'
    ...
    api.updateExpense(data).then(ui.updateExpenseSuccess).catch(ui.updateExpenseFailure);
  }
};
...
var onDelete = function onDelete(event) {
  ...
  if ($('#txtdeleteid').val() === '') {
    ...
    api.deleteExpense().then(ui.deleteExpenseSuccess).catch(ui.deleteExpenseFailure);
  }
};
